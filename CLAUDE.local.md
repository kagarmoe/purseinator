...
**YOU ARE IN: `purseinator/polecats/rust/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/purseinator/` (rig root) or other directories
...
**Your mail address:** `purseinator/polecats/rust`
**Your rig:** purseinator
**Your Witness:** `purseinator/witness`
...
| Ask Witness for help | `gt mail send purseinator/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`purseinator/witness`) when:
...
```bash
gt mail send purseinator/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
